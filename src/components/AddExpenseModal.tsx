...
export function AddExpenseModal({ open, onClose, onSuccess, vehicles, drivers = [], initialData }: AddExpenseModalProps) {
    ...
    const isAutoGenerated = isEdit && !!initialData?.source_table;
    ...
    useEffect(() => {
        ...
        if (initialData) {
            ...
            const isFuelCat = initialData.category === 'fuel';
            setForm({
            ...
            <div onClick={e => e.stopPropagation()} style={{
                ...
                {isAutoGenerated && (
                    <div style={{ marginBottom: 16, padding: '12px 14px', borderRadius: 8, background: '#3b82f615', border: '1px solid #3b82f640', fontSize: 13, color: '#3b82f6', display: 'flex', gap: 8 }}>
                        ...
                        This expense was auto-generated from a {initialData?.source_table?.replace(/_/g, ' ')} record.
                        To change it, edit the original {initialData?.source_table?.replace(/_/g, ' ')} entry.
                    </div>
                )}
