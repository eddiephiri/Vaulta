...
import type { Vehicle, ExpenseCategory, Driver } from '../types';
...
export function AddExpenseModal({ open, onClose, onSuccess, vehicles, drivers = [] }: AddExpenseModalProps) {
        ...
        <div onClick={onClose} style={{
            ...
            <div onClick={e => e.stopPropagation()} style={{
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                    ...
                    {/* Driver — shown when category is salary */}
