...
// service, tyre, and licensing are mostly auto-generated by database triggers, but we allow manual entry for 'service' now.
    ...
    return (
        <div onClick={onClose} style={{
            ...
            <div onClick={e => e.stopPropagation()} style={{
                background: 'var(--ff-surface)',
                border: '1px solid var(--ff-border)',
                borderRadius: 16, width: '100%', maxWidth: 'min(460px, 95vw)', padding: '24px 20px',
